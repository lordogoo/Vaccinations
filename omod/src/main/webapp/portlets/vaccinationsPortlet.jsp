...
<html class="no-js">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/moduleResources/vaccinations/styles/app-d8fe36d1.css">
  </head>
  <body>
...
<!-- <div id="appcontainer"> -->
    ...
    <div class="container" ng-controller="MainController">
        ...
        <div class="add-vaccination-wrapper">
            ...
            <div class="staged-wrapper" ng-if="stagedVaccinations.length > 0">
                ...
                <!-- STAGED VACCINATIONS -->
                <vaccination ng-if="stagedVaccinations" get-vaccination="stagedVaccinations[0]" get-routes="dropDownData.routes" get-dosing-units="dropDownData.dosingUnits" get-body-sites="dropDownData.bodySites"></vaccination>
                <!-- /STAGED VACCINATION -->
        ...
        <div class="vaccinations-wrapper">
            ...
            <div ng-repeat="(name, vaccinationsGroup) in vaccinations | filter: {scheduled: 'true'} | groupBy: 'name'">
                ...
                <vaccination get-vaccination="vaccination" get-routes="dropDownData.routes" get-dosing-units="dropDownData.dosingUnits" get-body-sites="dropDownData.bodySites" ng-repeat="vaccination in vaccinationsGroup | orderBy: ['dose_number']"></vaccination>
            </div>
            ...
            <div ng-repeat="(name, vaccinationsGroup) in vaccinations | filter: {scheduled: 'false'} | groupBy: 'name'">
                ...
                <div class="vaccination-group-header" ><span class="label label-default header-label" ng-bind="::name">Loading...</span></div>
                <vaccination get-vaccination="vaccination" get-routes="dropDownData.routes" get-dosing-units="dropDownData.dosingUnits" get-body-sites="dropDownData.bodySites" ng-repeat="vaccination in vaccinationsGroup | orderBy: ['scheduled_date']"></vaccination>
            </div>
    ...
    <script type="text/ng-template" id="/app/vaccination/administered/vaccination_administered.template.html">
        ...
        <div ng-controller="AdminVaccinationController" class="vaccination administered">
            ...
            <form  name="form" novalidate>
                  ...
                  <div class="form-group">
                    <label>Units</label>
                    <select name="dosing_unit" class="form-control" ng-model="enteredEditFormData.dosing_unit" ng-options="u.conceptId as u.name for u in getDosingUnits()" required>
                      <option value=""></option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    <label>Route</label>
                    <select name="route" class="form-control" ng-model="enteredEditFormData.route" ng-options="r.conceptId as r.name for r in getRoutes()" required>
                      <option value=""></option>
                    </select>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="body_site_administered" class="form-control" ng-model="enteredEditFormData.body_site_administered" ng-options="bs.name as bs.name for bs in getBodySites()" required>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select name="side_administered_left" class="form-control" ng-model="enteredEditFormData.side_administered_left" required ng-options="b.value as b.name for b in [{name:'left', value: true}, {name:'right', value: false}]">
                      <option value=""></option>
                   ...
                   <feedback warn="form.manufactur_date.$error.required || form.manufacture_date.$error.date" warning="Enter a valid manufacture date."></feedback>
                    ...
                    <!-- cannot delete scheduled vaccines. -->
                        ...
                        <button type="button" class="btn btn-danger" ng-if="!enteredEditFormData.scheduled" ng-click="deleteVaccination(enteredEditFormData)">Delete</button>
                         ...
                         <button ng-if="enteredEditFormData.scheduled && isUnadministerable()" type="submit" class="btn btn-warning" ng-click="unadministerVaccination(enteredEditFormData)">Unadminister</button>
    ...
    <script src="${pageContext.request.contextPath}/moduleResources/vaccinations/scripts/app-2f776de2.js"></script>
